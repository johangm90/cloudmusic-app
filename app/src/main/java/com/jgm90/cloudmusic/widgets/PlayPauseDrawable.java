...
public class PlayPauseDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        // The current getPosition of the left pause bar's top left coordinate.
        final float firstBarTopLeft = interpolate(0.0F, barWidth, progress);
        // The current getPosition of the right pause bar's top right coordinate.
        final float secondBarTopRight = interpolate(2.0F * barWidth + barDist, barWidth + barDist, progress);

        // Draw the left pause bar. The left pause bar transforms into the
        // top half of the play button triangle by animating the getPosition of the
        ...
        // bottom half of the play button triangle by animating the getPosition of the
